...
class Model:
    ...
    MODEL_PATH = './huangchunpeng.face.model.h5'
...
if __name__ == '__main__':
    ...
    model.build_model(dataset)
    model.train(dataset)
    model.save_model(file_path = './model/huangchunpeng.face.model.h5')
...
if __name__ == '__main__':    
    ...
    #评估模型
    model = Model()
    model.load_model(file_path = './model/huangchunpeng.face.model.h5')
